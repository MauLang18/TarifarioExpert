...
{
    internal class NavieroLCLConsultas
    {
        private ConexionMySql conexionMySql;
        private List<NavieroLCL> mConsulta;

        public NavieroLCLConsultas()
        {
            conexionMySql = new ConexionMySql();
            mConsulta = new List<NavieroLCL>();
        }

        public List<NavieroLCL> GetNaviero(string filtro, string filtro2)
        {
            string QUERY = "SELECT * FROM tb_flete_internacional_lcl ";
            ...
            try
            {
                ...
                NavieroLCL mDatos = null;
                while (mReader.Read())
                {
                    mDatos = new NavieroLCL();
                    mDatos.Id = mReader.GetInt32("id");
                    mDatos.Proveedor = mReader.GetString("proveedor");
                    mDatos.Thc_d_cbm = mReader.GetFloat("thc_d_cbm");
                    mDatos.Thc_d_minimo = mReader.GetFloat("thc_d_minimo");
                    mDatos.Vgm_minimo = mReader.GetFloat("vgm_minimo");
                    mDatos.Bunker_cbm = mReader.GetFloat("bunker_cbm");
                    mDatos.Bunker_minimo = mReader.GetFloat("bunker_minimo");
                    mDatos.Sed_minimo = mReader.GetFloat("sed_minimo");
                    mDatos.Tica_minimo = mReader.GetFloat("tica_minimo");
                    mDatos.Forwarding_minimo = mReader.GetFloat("forwarding_minimo");
                    mDatos.Manejos_minimo = mReader.GetFloat("manejos_minimo");
                    mDatos.Carga_peligrosa_minimo = mReader.GetFloat("carga_peligrosa_minimo");
        ...
        public List<NavieroLCL> getNaviero1()
        {
            string QUERY = "SELECT * FROM tb_flete_internacional_lcl;";
            MySqlDataReader mReader = null;
            try
        ...
        internal bool agregarFleteInternacional(NavieroLCL mFleteInternacional)
        {
            string QUERY = "CALL agregarFI_LCL(@proveedor,@thc,@doc_fee,@security,@impresion,@port,@canal_fee,@vac,@impdo,@merchant,@carga,@china,@india,@japon,@korea,@crc,@indonesia,@espana,@italia,@francia,@alemania,@dubai,@sudafrica,@thailandia,@taiwan,@holanda,@canada,@usa,@mexico,@guatemala,@panama,@nicaragua,@salvador,@honduras,@colombia,@ecuador,@peru,@brasil,@argentina,@chile,@uruguay,@paraguay,@suiza,@arabia,@argelia,@australia,@austria,@bahamas,@bangladesh,@barbados,@belgica,@belice,@bolivia,@croacia,@cuba,@dinamarca,@dominica,@egipto,@eslovaquia,@eslovenia,@rusia,@filipinas,@finlandia,@grecia,@haiti,@hungria,@irlandia,@islandia,@israel,@jamaica,@luxemburgo,@malasia,@maldivas,@marruecos,@monaco,@mongolia,@nepal,@noruega,@zelanda,@polonia,@portugal,@qatar,@uk,@rd,@singapur,@suecia,@tunez,@turquia,@ucrania,@venezuela,@vietnam,@rodman,@cristobal,@manzanillo,@balboa,@moin,@caldera,@no_aplica);";

            MySqlCommand mySqlCommand = new MySqlCommand(QUERY, conexionMySql.GetConnection());

            mySqlCommand.Parameters.Add(new MySqlParameter("@proveedor", mFleteInternacional.Proveedor));
            mySqlCommand.Parameters.Add(new MySqlParameter("@thc", mFleteInternacional.Thc_d_cbm));
            mySqlCommand.Parameters.Add(new MySqlParameter("@doc_fee", mFleteInternacional.Thc_d_minimo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@security", mFleteInternacional.Vgm_minimo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@impresion", mFleteInternacional.Bunker_cbm));
            mySqlCommand.Parameters.Add(new MySqlParameter("@port", mFleteInternacional.Bunker_minimo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@canal_fee", mFleteInternacional.Sed_minimo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@vac", mFleteInternacional.Tica_minimo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@impdo", mFleteInternacional.Forwarding_minimo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@merchant", mFleteInternacional.Manejos_minimo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@carga", mFleteInternacional.Carga_peligrosa_minimo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@china", mFleteInternacional.china));
            mySqlCommand.Parameters.Add(new MySqlParameter("@india", mFleteInternacional.india));
            mySqlCommand.Parameters.Add(new MySqlParameter("@japon", mFleteInternacional.japon));
            mySqlCommand.Parameters.Add(new MySqlParameter("@korea", mFleteInternacional.korea));
            mySqlCommand.Parameters.Add(new MySqlParameter("@crc", mFleteInternacional.crc));
            mySqlCommand.Parameters.Add(new MySqlParameter("@indonesia", mFleteInternacional.indonesia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@espana", mFleteInternacional.espana));
            mySqlCommand.Parameters.Add(new MySqlParameter("@italia", mFleteInternacional.italia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@francia", mFleteInternacional.francia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@alemania", mFleteInternacional.alemania));
            mySqlCommand.Parameters.Add(new MySqlParameter("@dubai", mFleteInternacional.dubai));
            mySqlCommand.Parameters.Add(new MySqlParameter("@sudafrica", mFleteInternacional.sudafrica));
            mySqlCommand.Parameters.Add(new MySqlParameter("@thailandia", mFleteInternacional.thailandia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@taiwan", mFleteInternacional.taiwan));
            mySqlCommand.Parameters.Add(new MySqlParameter("@holanda", mFleteInternacional.holanda));
            mySqlCommand.Parameters.Add(new MySqlParameter("@canada", mFleteInternacional.canada));
            mySqlCommand.Parameters.Add(new MySqlParameter("@usa", mFleteInternacional.usa));
            mySqlCommand.Parameters.Add(new MySqlParameter("@mexico", mFleteInternacional.maxico));
            mySqlCommand.Parameters.Add(new MySqlParameter("@guatemala", mFleteInternacional.guatemala));
            mySqlCommand.Parameters.Add(new MySqlParameter("@panama", mFleteInternacional.panama));
            mySqlCommand.Parameters.Add(new MySqlParameter("@nicaragua", mFleteInternacional.nicaragua));
            mySqlCommand.Parameters.Add(new MySqlParameter("@salvador", mFleteInternacional.salvador));
            mySqlCommand.Parameters.Add(new MySqlParameter("@honduras", mFleteInternacional.honduras));
            mySqlCommand.Parameters.Add(new MySqlParameter("@colombia", mFleteInternacional.colombia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@ecuador", mFleteInternacional.ecuador));
            mySqlCommand.Parameters.Add(new MySqlParameter("@peru", mFleteInternacional.peru));
            mySqlCommand.Parameters.Add(new MySqlParameter("@brasil", mFleteInternacional.brasil));
            mySqlCommand.Parameters.Add(new MySqlParameter("@argentina", mFleteInternacional.argentina));
            mySqlCommand.Parameters.Add(new MySqlParameter("@chile", mFleteInternacional.chile));
            mySqlCommand.Parameters.Add(new MySqlParameter("@uruguay", mFleteInternacional.uruguay));
            mySqlCommand.Parameters.Add(new MySqlParameter("@paraguay", mFleteInternacional.paraguay));
            mySqlCommand.Parameters.Add(new MySqlParameter("@suiza", mFleteInternacional.suiza));
            mySqlCommand.Parameters.Add(new MySqlParameter("@arabia", mFleteInternacional.arabia_saudi));
            mySqlCommand.Parameters.Add(new MySqlParameter("@argelia", mFleteInternacional.argelia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@australia", mFleteInternacional.australia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@austria", mFleteInternacional.austria));
            mySqlCommand.Parameters.Add(new MySqlParameter("@bahamas", mFleteInternacional.bahamas));
            mySqlCommand.Parameters.Add(new MySqlParameter("@bangladesh", mFleteInternacional.bangladesh));
            mySqlCommand.Parameters.Add(new MySqlParameter("@barbados", mFleteInternacional.barbados));
            mySqlCommand.Parameters.Add(new MySqlParameter("@belgica", mFleteInternacional.belgica));
            mySqlCommand.Parameters.Add(new MySqlParameter("@belice", mFleteInternacional.belice));
            mySqlCommand.Parameters.Add(new MySqlParameter("@bolivia", mFleteInternacional.bolivia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@croacia", mFleteInternacional.croacia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@cuba", mFleteInternacional.cuba));
            mySqlCommand.Parameters.Add(new MySqlParameter("@dinamarca", mFleteInternacional.dinamarca));
            mySqlCommand.Parameters.Add(new MySqlParameter("@dominica", mFleteInternacional.dominica));
            mySqlCommand.Parameters.Add(new MySqlParameter("@egipto", mFleteInternacional.egipto));
            mySqlCommand.Parameters.Add(new MySqlParameter("@eslovaquia", mFleteInternacional.eslovaquia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@eslovenia", mFleteInternacional.eslovenia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@rusia", mFleteInternacional.rusia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@filipinas", mFleteInternacional.flipinas));
            mySqlCommand.Parameters.Add(new MySqlParameter("@finlandia", mFleteInternacional.finlandia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@grecia", mFleteInternacional.grecia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@haiti", mFleteInternacional.haiti));
            mySqlCommand.Parameters.Add(new MySqlParameter("@hungria", mFleteInternacional.hungria));
            mySqlCommand.Parameters.Add(new MySqlParameter("@irlandia", mFleteInternacional.irlandia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@islandia", mFleteInternacional.islandia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@israel", mFleteInternacional.israel));
            mySqlCommand.Parameters.Add(new MySqlParameter("@jamaica", mFleteInternacional.jamaica));
            mySqlCommand.Parameters.Add(new MySqlParameter("@luxemburgo", mFleteInternacional.luxemburgo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@malasia", mFleteInternacional.malasia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@maldivas", mFleteInternacional.maldivas));
            mySqlCommand.Parameters.Add(new MySqlParameter("@marruecos", mFleteInternacional.marruecos));
            mySqlCommand.Parameters.Add(new MySqlParameter("@monaco", mFleteInternacional.monaco));
            mySqlCommand.Parameters.Add(new MySqlParameter("@mongolia", mFleteInternacional.mongolia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@nepal", mFleteInternacional.nepal));
            mySqlCommand.Parameters.Add(new MySqlParameter("@noruega", mFleteInternacional.noruega));
            mySqlCommand.Parameters.Add(new MySqlParameter("@zelanda", mFleteInternacional.nueva_zelanda));
            mySqlCommand.Parameters.Add(new MySqlParameter("@polonia", mFleteInternacional.polonia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@portugal", mFleteInternacional.portugal));
            mySqlCommand.Parameters.Add(new MySqlParameter("@qatar", mFleteInternacional.qatar));
            mySqlCommand.Parameters.Add(new MySqlParameter("@uk", mFleteInternacional.reino_unido));
            mySqlCommand.Parameters.Add(new MySqlParameter("@rd", mFleteInternacional.republica_dominicana));
            mySqlCommand.Parameters.Add(new MySqlParameter("@singapur", mFleteInternacional.singapur));
            mySqlCommand.Parameters.Add(new MySqlParameter("@suecia", mFleteInternacional.suecia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@tunez", mFleteInternacional.tunez));
            mySqlCommand.Parameters.Add(new MySqlParameter("@turquia", mFleteInternacional.turquia));
            mySqlCommand.Parameters.Add(new MySqlParameter("@ucrania", mFleteInternacional.ucrania));
            mySqlCommand.Parameters.Add(new MySqlParameter("@venezuela", mFleteInternacional.venezuela));
            mySqlCommand.Parameters.Add(new MySqlParameter("@vietnam", mFleteInternacional.vietnam));
            mySqlCommand.Parameters.Add(new MySqlParameter("@rodman", mFleteInternacional.rodman));
            mySqlCommand.Parameters.Add(new MySqlParameter("@cristobal", mFleteInternacional.cristobal));
            mySqlCommand.Parameters.Add(new MySqlParameter("@manzanillo", mFleteInternacional.manzanillo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@balboa", mFleteInternacional.balboa));
            mySqlCommand.Parameters.Add(new MySqlParameter("@moin", mFleteInternacional.moin));
            mySqlCommand.Parameters.Add(new MySqlParameter("@caldera", mFleteInternacional.caldera));
            mySqlCommand.Parameters.Add(new MySqlParameter("@no_aplica", mFleteInternacional.no_aplica));

            return mySqlCommand.ExecuteNonQuery() > 0;
        }

        internal bool eliminarFleteInternacional(NavieroLCL mFleteInternacional)
        {
            string QUERY = "CALL eliminarFI_LCL(@id);";

            MySqlCommand mySqlCommand = new MySqlCommand(QUERY, conexionMySql.GetConnection());

            mySqlCommand.Parameters.Add(new MySqlParameter("@id", mFleteInternacional.Id));

            return mySqlCommand.ExecuteNonQuery() > 0;
        }

        internal bool modificarFleteInternacional(NavieroLCL mFleteInternacional)
        {
            string QUERY = "CALL modificarFI_LCL(@id,@proveedor,@thc,@doc_fee,@security,@impresion,@port,@canal_fee,@vac,@impdo,@merchant,@carga,@china,@india,@japon,@korea,@crc,@indonesia,@espana,@italia,@francia,@alemania,@dubai,@sudafrica,@thailandia,@taiwan,@holanda,@canada,@usa,@mexico,@guatemala,@panama,@nicaragua,@salvador,@honduras,@colombia,@ecuador,@peru,@brasil,@argentina,@chile,@uruguay,@paraguay,@suiza,@arabia,@argelia,@australia,@austria,@bahamas,@bangladesh,@barbados,@belgica,@belice,@bolivia,@croacia,@cuba,@dinamarca,@dominica,@egipto,@eslovaquia,@eslovenia,@rusia,@filipinas,@finlandia,@grecia,@haiti,@hungria,@irlandia,@islandia,@israel,@jamaica,@luxemburgo,@malasia,@maldivas,@marruecos,@monaco,@mongolia,@nepal,@noruega,@zelanda,@polonia,@portugal,@qatar,@uk,@rd,@singapur,@suecia,@tunez,@turquia,@ucrania,@venezuela,@vietnam,@rodman,@cristobal,@manzanillo,@balboa,@moin,@caldera,@no_aplica);";
