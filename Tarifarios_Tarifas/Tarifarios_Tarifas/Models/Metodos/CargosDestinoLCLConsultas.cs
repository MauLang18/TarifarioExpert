...
{
    internal class CargosDestinoLCLConsultas
    {
        private ConexionMySql conexionMySql;
        private List<CargosDestinoLCL> mConsulta;

        public CargosDestinoLCLConsultas()
        {
            conexionMySql = new ConexionMySql();
            mConsulta = new List<CargosDestinoLCL>();
        }

        public List<CargosDestinoLCL> getCargosDestino(string filtro, string filtro2)
        {
            string QUERY = "SELECT * FROM tb_cargos_destino_lcl ";
            ...
            try
            {
                ...
                CargosDestinoLCL mDatos = null;
                while (mReader.Read())
                {
                    mDatos = new CargosDestinoLCL();
        ...
        public List<CargosDestinoLCL> getCargosDestino1()
        {
            string QUERY = "SELECT * FROM tb_cargos_destino_lcl;";
            MySqlDataReader mReader = null;
            try
        ...
        internal bool eliminarCargosDestino(CargosDestinoLCL mCargosDestino)
        {
            string QUERY = "CALL eliminarCD_LCL(@id);";
        ...
        internal bool modificarCargosDestino(CargosDestinoLCL mCargosDestino)
        {
            string QUERY = "CALL modificarCD_LCL(@id,@proveedor,@flete,@china,@india,@japon,@korea,@crc,@indonesia,@espana,@italia,@francia,@alemania,@dubai,@sudafrica,@thailandia,@taiwan,@holanda,@canada,@usa,@mexico,@guatemala,@panama,@nicaragua,@salvador,@honduras,@colombia,@ecuador,@peru,@brasil,@argentina,@chile,@uruguay,@paraguay,@suiza,@arabia,@argelia,@australia,@austria,@bahamas,@bangladesh,@barbados,@belgica,@belice,@bolivia,@croacia,@cuba,@dinamarca,@dominica,@egipto,@eslovaquia,@eslovenia,@rusia,@filipinas,@finlandia,@grecia,@haiti,@hungria,@irlandia,@islandia,@israel,@jamaica,@luxemburgo,@malasia,@maldivas,@marruecos,@monaco,@mongolia,@nepal,@noruega,@zelanda,@polonia,@portugal,@qatar,@uk,@rd,@singapur,@suecia,@tunez,@turquia,@ucrania,@venezuela,@vietnam,@rodman,@cristobal,@manzanillo,@balboa,@moin,@caldera,@no_aplica);";
