...
{
    internal class NavieroConsultas
    {
        private ConexionMySql conexionMySql;
        private List<Naviero> mConsulta;

        public NavieroConsultas()
        {
            conexionMySql = new ConexionMySql();
            mConsulta = new List<Naviero>();
        }

        public List<Naviero> GetNaviero(string filtro, string filtro2)
        {
            string QUERY = "SELECT * FROM tb_flete_internacional ";
            ...
            try
            {
                ...
                while (mReader.Read())
                {
                    ...
                    mDatos.Thc = mReader.GetFloat("thc");
                    mDatos.Doc_fee = mReader.GetFloat("doc_fee");
                    mDatos.Security = mReader.GetFloat("security_");
                    mDatos.Impresion_bl = mReader.GetFloat("impresion_bl");
                    mDatos.Port_facility = mReader.GetFloat("port_facility");
                    mDatos.Canal_fee = mReader.GetFloat("canal_fee");
                    mDatos.Vac = mReader.GetFloat("vac");
                    mDatos.Merchant = mReader.GetFloat("merchant");
        ...
        public List<Naviero> getNaviero1()
        {
            string QUERY = "SELECT * FROM tb_flete_internacional;";
            MySqlDataReader mReader = null;
            try
        ...
        internal bool agregarFleteInternacional(Naviero mFleteInternacional)
        {
            ...
            mySqlCommand.Parameters.Add(new MySqlParameter("@thc", mFleteInternacional.Thc));
            mySqlCommand.Parameters.Add(new MySqlParameter("@doc_fee", mFleteInternacional.Doc_fee));
            mySqlCommand.Parameters.Add(new MySqlParameter("@security", mFleteInternacional.Security));
            mySqlCommand.Parameters.Add(new MySqlParameter("@impresion", mFleteInternacional.Impresion_bl));
            mySqlCommand.Parameters.Add(new MySqlParameter("@port", mFleteInternacional.Port_facility));
            mySqlCommand.Parameters.Add(new MySqlParameter("@canal_fee", mFleteInternacional.Canal_fee));
            mySqlCommand.Parameters.Add(new MySqlParameter("@vac", mFleteInternacional.Vac));
            mySqlCommand.Parameters.Add(new MySqlParameter("@impdo", mFleteInternacional.Impdo));
            mySqlCommand.Parameters.Add(new MySqlParameter("@merchant", mFleteInternacional.Merchant));
        ...
        internal bool eliminarFleteInternacional(Naviero mFleteInternacional)
        {
            string QUERY = "CALL eliminarFI(@id);";
        ...
        internal bool modificarFleteInternacional(Naviero mFleteInternacional)
        {
            string QUERY = "CALL modificarFI(@id,@proveedor,@thc,@doc_fee,@security,@impresion,@port,@canal_fee,@vac,@impdo,@merchant,@china,@india,@japon,@korea,@crc,@indonesia,@espana,@italia,@francia,@alemania,@dubai,@sudafrica,@thailandia,@taiwan,@holanda,@canada,@usa,@mexico,@guatemala,@panama,@nicaragua,@salvador,@honduras,@colombia,@ecuador,@peru,@brasil,@argentina,@chile,@uruguay,@paraguay,@suiza,@arabia,@argelia,@australia,@austria,@bahamas,@bangladesh,@barbados,@belgica,@belice,@bolivia,@croacia,@cuba,@dinamarca,@dominica,@egipto,@eslovaquia,@eslovenia,@rusia,@filipinas,@finlandia,@grecia,@haiti,@hungria,@irlandia,@islandia,@israel,@jamaica,@luxemburgo,@malasia,@maldivas,@marruecos,@monaco,@mongolia,@nepal,@noruega,@zelanda,@polonia,@portugal,@qatar,@uk,@rd,@singapur,@suecia,@tunez,@turquia,@ucrania,@venezuela,@vietnam,@rodman,@cristobal,@manzanillo,@balboa,@moin,@caldera,@no_aplica);";
